package com.wy.demo.mybatiesInterceptor3.config;


import com.wy.demo.mybatiesInterceptor3.interceptor.PrepareInterceptor;
import com.wy.demo.mybatiesInterceptor3.sql.IDataLimitSql;
import com.wy.demo.mybatiesInterceptor3.threadlocal.DataLimitlDefinitionHolder;
...
public class DataLimitConfig implements ApplicationListener<ContextRefreshedEvent> {
    ...
    // 查询数据权限元数据SQL
    private static final String QUERY_META = "SELECT META_ID,META_DATA,META_TYPE,META_PARAM FROM MYBATIS_DATALIMIT_META";
